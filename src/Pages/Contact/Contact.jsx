    ...
    <div className='contact-page'>
        <header className='height-75'>
            <div className='container h-100 d-flex flex-column align-items-center justify-content-center text-light'>
                ...
                <p className='text-center w-75 mb-5'>We are excited to connect 
                    with prospective students, parents, alumni, and partners. 
                    Whether you have questions about our programs, need assistance 
                    with your application, or want to learn more about campus life, 
