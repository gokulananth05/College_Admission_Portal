  ...
  return (
    <div>
        <div className="container">
            <h2 className='text-center mb-5'>Why choose Harvard University ?</h2>
                ...
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            Awarded for outstanding performance in coursework and 
                            achieving the highest grades in the university.  Given 
                            for exceptional dedication to student support services, 
                            helping students navigate their academic and personal challenges, 
                            and fostering a positive and inclusive university community
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                            Our university is dedicated to creating an environment 
                            where students thrive academically, socially, and emotionally. 
                            We believe that a happy student is a successful student, and 
                            beyond to ensure that our students are well-supported throughout their academic journey
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                            Our university prides itself on providing top-tier education 
                            and exceptional student experiences across three vibrant and 
                            culturally rich locations in the UK. Each campus offers unique 
                            opportunities, facilities, and local attractions, ensuring that 
                            students can find the perfect environment to thrive academically and personally.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
